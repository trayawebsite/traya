...
- **[MED] Saffron Route validated.** Warm cream + turmeric-saffron #C4820A (not banking-gold) + forest-green reads "premium ingredient house" (earthy/warm), not "cheap commodity exporter." Earth tones / saffron-turmeric / greens dominate the premium ingredient register. — *design judgment from verified competitor register + Paper Heart spice palette*
- **[MED] Fonts:** Fraunces is a display Old-Style soft-serif (inspired by Windsor/Souvenir/Cooper) — best for display/headlines; its optical-size axis allows small use but **pairing with Figtree for body is the correct choice.** Figtree = clean humanist sans, good body face. — *Undercase Type foundry, Google Fonts, Pimp My Type*
