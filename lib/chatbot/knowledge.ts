...
## What Traya exports
Traya works across Food & Agro, Chemicals, Mechanical products, and Paper. The online product catalogue currently covers the Food & Agro range: 150+ products across 18 categories — for example dehydrated onion and garlic, dehydrated vegetables, spray-dried powders, spices and seasonings, culinary herbs, herbal & nutraceutical products, and dairy & premium wellness lines. For chemicals, mechanical products, paper, or anything not listed, buyers are invited to send their requirement.
