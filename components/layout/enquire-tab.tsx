...
// NOTE: this element uses `writing-mode: vertical-rl`, so LOGICAL utilities
// (end-*/rounded-e-*) resolve against the vertical axis (inline-end = bottom),
// which would pin it to the bottom and stretch its height. We therefore use
// PHYSICAL right/rounded-r here and flip to the left edge in RTL explicitly.
