  ...
  return (
    <div className="fixed inset-x-0 top-0 z-[100] flex items-center justify-center gap-3 bg-traya-deep px-4 py-2.5 text-sm text-traya-cream shadow-lg">
      ...
      <button
        ...
        className="rounded-md bg-traya-cream/15 px-3 py-1 font-medium transition-colors hover:bg-traya-cream/25"
      >
      ...
      <button
        onClick={dismiss}
        aria-label="Dismiss"
        className="ml-1 rounded-md p-1 text-traya-cream/60 transition-colors hover:text-traya-cream"
      >
