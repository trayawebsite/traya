...
export function FloatingActions() {
  ...
  return (
    <>
      ...
      {/* WhatsApp — official multi-colour mark (brand asset, colours not tokenised) */}
      {waHref && (
        <a
          href={waHref}
          target="_blank"
          ...
          className="inline-flex h-14 w-14 items-center justify-center rounded-full border-2 border-whatsapp bg-white shadow-lg transition-[box-shadow,transform] duration-150 ease-out hover:shadow-xl active:scale-[0.96] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-whatsapp focus-visible:ring-offset-2 focus-visible:ring-offset-background motion-reduce:transition-none"
        >
          <svg viewBox="0 0 32 32" fill="none" className="wa-icon h-7 w-7" aria-hidden="true">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
