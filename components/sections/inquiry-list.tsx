...
// Local schema for the inquiry-list form fields. productName and message are
...
export function InquiryListView() {
  const t = useTranslations("inquiry.list");
        ...
        <div className="mx-auto max-w-3xl">
          ...
          {items.length === 0 ? (
            <div className="mt-12 rounded-2xl border border-dashed border-traya-border bg-traya-surface/50 py-16 text-center">
              ...
              <Link
                href="/products"
                className={`${primaryButton} mt-6 inline-flex`}
              >
                {t("browseProducts")}
              </Link>
            </div>
