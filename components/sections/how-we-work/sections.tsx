          ...
          <div className="mt-12 grid gap-px overflow-hidden rounded-2xl border border-traya-border bg-traya-border sm:grid-cols-2">
            {items.map((k, i) => (
              <div
                key={k}
                data-stagger
                className="flex gap-5 bg-background p-7 transition-colors hover:bg-traya-surface"
              >
            ...
            <div className="flex items-center bg-traya-surface p-7">
              <p className="font-display text-lg italic leading-snug text-foreground/70">
                “{t("quote")}”
              </p>
            </div>
          </div>
            ...
            {steps.map((k, i) => (
              <li key={k} data-stagger className="relative">
                <p className="flex items-center gap-2 font-mono text-[11px] font-semibold uppercase tracking-[0.16em] text-traya-saffron-lo">
                  <span
                    className="size-2 rounded-full bg-traya-red"
                    aria-hidden
                  />
        ...
        <Container className="py-section">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            {modes.map(({ key, icon }) => (
              ...
              >
                <span className="grid size-11 place-items-center text-traya-red-hi">
                  {icon}
                </span>
                <h3 className="mt-5 font-display text-lg text-traya-cream">
                  {t(`${key}Title`)}
                </h3>
