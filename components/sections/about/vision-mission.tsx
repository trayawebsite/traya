...
const MISSION_ICONS = [
  <svg key="0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="size-7" aria-hidden="true">
    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Z" />
    <path d="m9 12 2 2 4-4" />
  </svg>,
  <svg key="1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" className="size-7" aria-hidden="true">
  ...
  <svg key="2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="size-7" aria-hidden="true">
    <rect x="8" y="2" width="8" height="4" rx="1" />
    <path d="M16 4h1a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h1" />
    <path d="m9 14 2 2 4-4" />
  </svg>,
  <svg key="3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" className="size-7" aria-hidden="true">
  ...
  return (
    <section className="border-b border-traya-border bg-background">
      <Container className="py-section-lg">
        <div className="grid items-start gap-16 divide-y divide-traya-border lg:grid-cols-2 lg:gap-20 lg:divide-x lg:divide-y-0">
          {/* Vision   left */}
          <div>
            ...
            <Image
              ...
              className="mt-8 h-64 w-full max-w-md object-cover"
            />
          </div>
            ...
            <div className="mt-6 space-y-6">
              {missionPoints.map((m, i) => (
                <div
                  key={i}
                  data-stagger
                  className="flex items-center gap-5 border-t border-traya-border pt-5"
                >
                  <IconChip className="size-14 shrink-0">
                    {MISSION_ICONS[i % MISSION_ICONS.length]}
                  </IconChip>
                  <p className="leading-relaxed text-foreground/90">{m}</p>
                </div>
              ))}
            </div>
          </div>
