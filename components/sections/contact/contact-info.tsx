      ...
      <Container className="pt-section-sm pb-section-lg">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[0.48fr_0.52fr] lg:gap-16">
          <div className="max-w-xl">
            ...
            <a href="#inquiry" className={`mt-7 ${primaryButton}`}>
              {t("hero.cta")}
          ...
          {s.contact.email && (
            <ContactCard icon={MailIcon} label={t("emailLabel")}>
              <a
                ...
                className={`text-foreground ${linkCls}`}
              >
                {s.contact.email}
              </a>
            </ContactCard>
          ...
          {waHref && (
            <ContactCard icon={WhatsAppIcon} label={t("whatsappLabel")}>
              <a
                ...
                className={`block text-foreground ${linkCls}`}
              >
                {t("whatsappCta")}
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`mt-1 flex items-center gap-1.5 text-sm text-muted-foreground ${linkCls}`}
              >
                {cloneElement(WhatsAppIcon, { className: "size-4 shrink-0" })}
                {s.contact.phone}
              </a>
            </ContactCard>
          )}
...
function ContactCard({
  ...
  return (
    <div
      data-stagger
      className="rounded-2xl border border-traya-border bg-card p-6 transition-shadow duration-200 hover:shadow-sm sm:p-7"
    >
