...
export async function OrganizationSchema() {
  ...
  const schema = {
    ...
    description:
      "Indian food ingredient exporter specializing in dehydrated products, spices, spray-dried powders, herbs & nutraceuticals. FSSAI-licensed and APEDA-registered B2B supplier.",
    founder: {
      "@type": "Person",
      name: "Neha Pardeshi",
    ...
    sameAs: [s.socials.linkedin, s.socials.instagram].filter(Boolean),
...
export function WebsiteSchema() {
  const schema = {
    ...
    url: siteUrl,
    description:
      "Indian food ingredient exporter. Dehydrated products, spices, powders, herbs & more.",
  };
