...
export const metadata: Metadata = {
  ...
  title: {
    default:
      "Traya International Exim LLP | Indian Food Ingredient Exporter | B2B Supplier India",
    template: "%s | Traya International Exim",
  },
  description:
    "Leading Indian food ingredient & chemicals exporter. Dehydrated onions, garlic, spices, spray-dried powders, herbs, nutraceuticals, dyes, food colours & pigments. FSSAI-licensed & APEDA-registered. 450+ products across 28 categories. B2B wholesale supplier from India.",
  keywords: [
      ...
      <body className="flex min-h-full flex-col">
        ...
        <NextIntlClientProvider messages={messages}>
          <InquiryProvider>
            ...
            <a
              href="#main"
              className="sr-only focus:fixed focus:start-4 focus:top-4 focus:z-60 focus:rounded-md focus:bg-background focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-foreground focus:shadow-md focus:outline-none focus:ring-2 focus:ring-ring"
            >
              {t("skip")}
            </a>
            <TopBar />
